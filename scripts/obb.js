...
import { pointOntoLine, perpendicular } from "./projection.js";
import { Polygon } from './poly.js';
import { comparePointsXY, comparePointsYXdown } from "./point.js";
...
export function minOBB(points) {
   ...
   // hull.draw(ctx, 1, 'red', 'rgba(255, 0, 0, 0.1)'); 
    ...
    for (let i = 0; i < n; i++) {
        ...
        let curSquare = Math.abs(crossProduct(v[0], v[1], v[0], v[3]));
        if (curSquare < minSquare) {
            minSquare = curSquare;
            minOBBVer = v;
        }
